            ...
            <div class="col-lg-8">
                <div class="all-blog-posts">
                    <div class="row">
                        ...
                        $sql = "SELECT post.*,category.name as categoryName,admin.name as Author FROM post INNER JOIN category ON post.category_id=category.id INNER JOIN admin ON post.admin_id=admin.id WHERE is_published='Published' ORDER BY post.id DESC  LIMIT $starting_limit,$perPage";
                        $stmt = $conn->query($sql);
